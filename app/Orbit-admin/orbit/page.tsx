...
function avatarColor(str: string) {
  const colors = ["#0284C7","#0369a1","#0ea5e9","#0891b2","#075985","#06b6d4"];
  let h = 0;
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <Link href="/Orbit-admin/orbit/queues"
          className="group flex items-center gap-4 rounded-[var(--radius-xl)] border border-border/60 bg-card p-4 shadow-[var(--shadow-card)] transition hover:shadow-[var(--shadow-raised)]">
        ...
        <div className="overflow-hidden rounded-[var(--radius-xl)] border border-border/60 bg-card shadow-[var(--shadow-card)]">
          <div className="flex items-center justify-between px-5 py-4">
            ...
            <Link href="/Orbit-admin/orbit/users"
              className="flex items-center gap-1 rounded-[var(--radius-md)] bg-muted/50 px-3 py-1.5 text-xs font-semibold text-foreground/70 transition hover:bg-muted">
              View all
            ...
            {recentUsers.map((u, i) => {
              ...
              return (
                <Link key={u.id} href={`/Orbit-admin/orbit/users/${u.id}`}
                  className="group flex items-center gap-3.5 px-5 py-3.5 transition hover:bg-accent/40"
...
function StatCard({
  ...
  return (
    <Link href={href}
      className="group relative flex flex-col justify-between overflow-hidden rounded-[var(--radius-xl)] border border-border/60 bg-card p-5 shadow-[var(--shadow-card)] transition hover:-translate-y-0.5 hover:shadow-[var(--shadow-raised)]">
      {/* Top accent */}
      ...
      <div className="flex items-start justify-between">
        <div className="flex size-9 items-center justify-center rounded-[var(--radius-lg)] transition-transform group-hover:scale-110"
