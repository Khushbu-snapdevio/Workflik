...
export async function PATCH(req: Request, { params }: { params: Promise<{ id: string; viewId: string }> }) {
  ...
  const allowed = ["name", "type", "filters", "sorts", "groupByPropertyId", "calendarPropertyId", "ganttStartPropertyId", "ganttEndPropertyId", "cardDisplayProps", "hiddenPropertyIds", "boardSettings", "galleryCardSize", "entryOpenMode", "filterLogic", "propertyOverrides", "propertyOrder"];
