    ...
    <main className="grid min-h-screen place-items-center bg-page px-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col gap-2.5">
          <button
            className="inline-flex h-9 w-full items-center justify-center rounded-[var(--radius-sm)] bg-primary px-4 text-[13px] font-semibold text-primary-foreground shadow-[var(--shadow-card)] transition-all hover:bg-[var(--primary-hover)] active:scale-[0.97]"
          ...
          <a
            className="inline-flex h-9 w-full items-center justify-center rounded-[var(--radius-sm)] border border-border px-4 text-[13px] font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
