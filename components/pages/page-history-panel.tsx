...
function avatarBg(str: string) {
  const p = ["#0284C7","#0369a1","#0ea5e9","#0891b2","#06b6d4","#075985"];
  let h = 0;
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          width:     300,
          maxHeight: 460,
          boxShadow: "0 8px 30px rgba(15,23,42,0.12), 0 2px 8px rgba(15,23,42,0.06), 0 0 0 1px rgba(0,0,0,0.04)",
        }}
      >
        {/* ── Header ── */}
        <div className="shrink-0 border-b border-border/60 bg-gradient-to-b from-sky-50/60 to-transparent px-4 pt-3.5 pb-3">
          <div className="flex items-start justify-between gap-2">
            ...
            <button
              type="button"
              onClick={onClose}
              className="flex size-6 shrink-0 items-center justify-center rounded-[var(--radius-sm)] text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
            >
                  ...
                  {items.map((v) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Avatar */}
                        <div
                          className="flex size-[26px] shrink-0 items-center justify-center rounded-full text-[9.5px] font-bold text-white ring-[1.5px] ring-white shadow-sm"
                        ...
                        {!isCur && (
                          <button
                            ...
                            className="shrink-0 rounded-[var(--radius-sm)] border border-border bg-background px-2 py-0.5 text-[10.5px] font-medium text-muted-foreground opacity-0 shadow-sm transition-all group-hover:opacity-100 hover:border-primary/40 hover:bg-primary/[0.04] hover:text-primary"
                          >
                            Restore
                          </button>
                        )}
          ...
          <div className="relative w-[380px] rounded-[var(--radius-lg)] border border-border bg-popover p-6 shadow-[var(--shadow-float)]">
            ...
            <div className="flex items-center justify-end gap-2">
              <button
                ...
                className="rounded-[var(--radius-sm)] border border-border px-4 py-1.5 text-[13px] font-medium text-foreground transition-colors hover:bg-muted disabled:opacity-50"
              >
                Cancel
              </button>
              <button
