      ...
      <div className="overflow-hidden rounded-[var(--radius-lg)] border border-border bg-card shadow-[var(--shadow-card)]">
        ...
        <div className="px-5 py-4">
          <form action={nameAction} className="space-y-3">
            ...
            <button
              className="inline-flex h-8 items-center rounded-[var(--radius-sm)] bg-primary px-4 text-[12.5px] font-semibold text-primary-foreground shadow-[var(--shadow-card)] transition-all hover:bg-[var(--primary-hover)] active:scale-[0.97] disabled:opacity-60"
...
export function DeleteAccountForm({ email }: { email: string }) {
  ...
  return (
    <div className="overflow-hidden rounded-[var(--radius-lg)] border border-destructive/30 bg-card shadow-[var(--shadow-card)]">
      ...
      <div className="px-5 py-4">
        <form action={action} className="space-y-3">
          ...
          <button
            className="inline-flex h-8 items-center rounded-[var(--radius-sm)] bg-destructive px-4 text-[12.5px] font-semibold text-white shadow-[var(--shadow-card)] transition-all hover:brightness-110 active:scale-[0.97] disabled:opacity-60"
            disabled={pending}
            type="submit"
          >
