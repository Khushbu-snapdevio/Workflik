    ...
    <div className="flex items-center gap-2.5">
     ...
     {otherSessionCount > 0 && (
      <form action={signOutOtherSessionsAction} className="ml-auto">
       <button
        className="inline-flex h-7 items-center rounded-[var(--radius-sm)] border border-border px-3 text-[12px] font-medium text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"
        type="submit"
       >
