...
export function SearchTrigger() {
  return (
    <button
      ...
      className="flex h-9 w-48 items-center gap-2 rounded-[var(--radius-sm)] border border-border bg-background px-3 text-muted-foreground transition-colors hover:border-primary/40 hover:bg-muted/30"
    >
