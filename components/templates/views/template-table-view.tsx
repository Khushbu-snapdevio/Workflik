...
import {
  PlusIcon, DotsThreeIcon, TrashIcon, CopyIcon,
  ArrowSquareOutIcon, TextTIcon, NumberCircleOneIcon,
  CalendarBlankIcon, CheckSquareIcon, LinkIcon,
  ListBulletsIcon, TagIcon, CaretDownIcon,
  PencilSimpleIcon, UserIcon,
    ...
    <div className="flex items-center justify-between gap-1 w-full">
      ...
      <div ref={menuRef} className="relative shrink-0">
        <button
          ...
          className="flex size-5 items-center justify-center rounded text-muted-foreground/40 opacity-0 group-hover/col:opacity-100 hover:bg-muted hover:text-foreground transition-all"
        >
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex size-5 items-center justify-center rounded text-muted-foreground opacity-0 group-hover/row:opacity-100 hover:bg-muted hover:text-foreground transition-all"
        title="Row actions"
      >
        <DotsThreeIcon size={14} weight="bold" />
      </button>
