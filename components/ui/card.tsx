...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "card group/card flex flex-col gap-(--card-spacing) overflow-hidden rounded-md bg-base-100 py-(--card-spacing) text-sm text-base-content border border-base-300 [--card-spacing:--spacing(6)] has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(4)] *:[img:first-child]:rounded-none *:[img:last-child]:rounded-none",
        className
      )}
      {...props}
    />
