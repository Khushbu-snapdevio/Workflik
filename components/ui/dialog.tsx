...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-heading text-lg leading-none font-semibold tracking-[0.125px]",
        className
      )}
      {...props}
    />
