...
Built-in template content is authored and managed here by the Pagevo team. End users and workspace Admins have no access. See the [Templates](./templates.md) document for the full specification.
