...
| 5 | **Pages** | Page CRUD, unlimited subpage hierarchy, icons (emoji + image), cover banner, move/duplicate, trash/restore, page lock, layout options (full-width / small text / font), version history (7-day), export (Markdown / HTML), trash + version cleanup jobs |
