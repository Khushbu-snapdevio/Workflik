...
The sidebar is the primary navigation structure in Pagevo. It gives users instant access to their pages, workspaces, search, and settings. The sidebar is always present on desktop and collapses to a peek or fully hidden mode when not needed.
