...
Notifications keep users informed about activity that involves them — @mentions, replies to their comments, and changes to pages they care about. Pagevo delivers notifications in-app in real time and via email on a configurable schedule.
...
```
Subject: Your Pagevo activity for Wednesday, Jun 4
