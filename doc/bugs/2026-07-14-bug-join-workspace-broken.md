...
This is also a mismatch with the product itself: Pagevo targets small, known teams (3–15 people) — a "anyone with this link can join" mechanism is a pattern suited to larger, open communities, not a small team where the admin already knows exactly who should have access.
